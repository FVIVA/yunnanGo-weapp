<template>
  <div
    @click.stop="gotoDetail(good.goodId)"
    class="card ub-box z-padding-v-10-px"
  ...
  >
    ...
    <div class="z-padding-h-10-px ub-flex-1 ub-box ub-col">
      <p class="ub-flex-1 ub-box ub-ver ub-between">
        <span
          class="z-width-80-percent z-font-size-15 z-lineHeight-26 z-lines-1-overflow-hidden z-font-weight-bold"
        >{{good.mainTitle}}</span>
  ...
  data () {
    return {
      good: {
        goodId: '100',
        img:
          'http://p0.meituan.net/200.0/deal/522fd16a9b25479496188b59476d1b941062402.jpg@206_0_828_828a%7C267h_267w_2e_90Q',
